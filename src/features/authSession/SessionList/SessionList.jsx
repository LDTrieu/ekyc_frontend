...
import useFetchAllSession from "./hooks/useFetchAllSession";
...
const SessionList = (props) => {
  const { session_list } = useFetchAllSession();
...
//   const showDetailSession=(sessionId)=>{
//     try {
//       // const response =
                  ...
                  <tr className="h-24 border-gray-300 dark:border-gray-200 border-b">
                    ...
                    <td className="pl-8 pr-6 text-left whitespace-no-wrap text-sm text-gray-800 dark:text-gray-100 tracking-normal leading-4">
                      {/* <input
                        type="radio"
                        className="cursor-pointer relative w-5 h-5 border rounded border-gray-400 dark:border-gray-200 bg-white dark:bg-gray-800 outline-none"
                        checked={selectedSession === item}
                        onChange={() => onSelectSession(item)}
                      /> */}
                    </td>
                    ...
                    <td className="pr-8 relative">
                     ...
                     //onClick={detailStudent}
                      // onClick={() => {
                      //   showDetailSession(item.sessionId);
                      // }}
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
